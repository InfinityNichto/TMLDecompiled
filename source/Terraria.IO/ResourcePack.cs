...
public class ResourcePack
{
	...
	private void LoadManifest()
	{
		...
		Name = Extensions.Value<string>((IEnumerable<JToken>)jObject["Name"]);
		Description = Extensions.Value<string>((IEnumerable<JToken>)jObject["Description"]);
		Author = Extensions.Value<string>((IEnumerable<JToken>)jObject["Author"]);

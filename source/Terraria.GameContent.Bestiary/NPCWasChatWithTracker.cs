...
public class NPCWasChatWithTracker : IPersistentPerWorldContent, IOnPlayerJoining
{
	...
	public void Save(BinaryWriter writer)
	{
		...
		{
			int value;
			IEnumerable<string> vanillaOnly = _chattedWithPlayer.Where((string persistentId) => ContentSamples.NpcNetIdsByPersistentIds.TryGetValue(persistentId, out value) && value < NPCID.Count);

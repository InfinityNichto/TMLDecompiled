...
public class NPCKillsTracker : IPersistentPerWorldContent, IOnPlayerJoining
{
	...
	public void Save(BinaryWriter writer)
	{
		...
		{
			int value;
			IEnumerable<KeyValuePair<string, int>> vanillaOnly = _killCountsByNpcId.Where((KeyValuePair<string, int> pair) => ContentSamples.NpcNetIdsByPersistentIds.TryGetValue(pair.Key, out value) && value < NPCID.Count);

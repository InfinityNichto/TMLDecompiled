...
public class NPCWasNearPlayerTracker : IPersistentPerWorldContent, IOnPlayerJoining
{
	...
	public void Save(BinaryWriter writer)
	{
		...
		{
			int value;
			IEnumerable<string> vanillaOnly = _wasNearPlayer.Where((string persistentId) => ContentSamples.NpcNetIdsByPersistentIds.TryGetValue(persistentId, out value) && value < NPCID.Count);

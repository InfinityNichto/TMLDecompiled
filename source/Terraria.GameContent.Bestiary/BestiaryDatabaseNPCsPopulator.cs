...
public class BestiaryDatabaseNPCsPopulator
{
	public static class CommonTags
	{
		public static class SpawnConditions
		{
			public static class Invasions
			{
				...
				public static SpawnConditionBestiaryInfoElement Martian = new SpawnConditionBestiaryInfoElement("Bestiary_Invasions.Martian", 53, "Images/MapBG1", (Color?)new Color(35, 40, 40));
				...
				public static SpawnConditionBestiaryInfoElement PumpkinMoon = new SpawnConditionBestiaryInfoElement("Bestiary_Invasions.PumpkinMoon", 51, "Images/MapBG1", (Color?)new Color(35, 40, 40));

				public static SpawnConditionBestiaryInfoElement FrostMoon = new SpawnConditionBestiaryInfoElement("Bestiary_Invasions.FrostMoon", 52, "Images/MapBG12", (Color?)new Color(35, 40, 40));
			...
			public static class Events
			{
				...
				public static SpawnConditionBestiaryInfoElement BloodMoon = new SpawnConditionBestiaryInfoElement("Bestiary_Events.BloodMoon", 38, "Images/MapBG26", (Color?)new Color(200, 190, 180))
				{
					DisplayTextPriority = 1,
					OrderPriority = -2f
				};
				...
				public static SpawnConditionBestiaryInfoElement Eclipse = new SpawnConditionBestiaryInfoElement("Bestiary_Events.Eclipse", 39, "Images/MapBG1", (Color?)new Color(60, 30, 0))
				{
					DisplayTextPriority = 1,
					OrderPriority = -2f
				};
			...
			{
				public static SpawnConditionBestiaryInfoElement TheCorruption = new SpawnConditionBestiaryInfoElement("Bestiary_Biomes.TheCorruption", 7, "Images/MapBG6", (Color?)new Color(200, 200, 200));

				public static SpawnConditionBestiaryInfoElement TheCrimson = new SpawnConditionBestiaryInfoElement("Bestiary_Biomes.Crimson", 12, "Images/MapBG7", (Color?)new Color(200, 200, 200));
				...
				public static SpawnConditionBestiaryInfoElement Meteor = new SpawnConditionBestiaryInfoElement("Bestiary_Biomes.Meteor", 44, "Images/MapBG1", (Color?)new Color(35, 40, 40));
				...
				public static SpawnConditionBestiaryInfoElement Granite = new SpawnConditionBestiaryInfoElement("Bestiary_Biomes.Granite", 30, "Images/MapBG17", (Color?)new Color(100, 100, 100));
				...
				public static SpawnConditionBestiaryInfoElement CorruptIce = new SpawnConditionBestiaryInfoElement("Bestiary_Biomes.CorruptIce", 11, "Images/MapBG34", (Color?)new Color(200, 200, 200));

				public static SpawnConditionBestiaryInfoElement HallowIce = new SpawnConditionBestiaryInfoElement("Bestiary_Biomes.HallowIce", 21, "Images/MapBG36", (Color?)new Color(200, 200, 200));

				public static SpawnConditionBestiaryInfoElement CrimsonIce = new SpawnConditionBestiaryInfoElement("Bestiary_Biomes.CrimsonIce", 16, "Images/MapBG35", (Color?)new Color(200, 200, 200));
			...
			public static class Times
			{
				...
				public static SpawnConditionBestiaryInfoElement NightTime = new SpawnConditionBestiaryInfoElement("Bestiary_Times.NightTime", 37, "Images/MapBG1", (Color?)new Color(35, 40, 40))
				{
					DisplayTextPriority = -1,
					OrderPriority = -1f
				};
			...
			public static class Visuals
			{
				...
				public static SpawnConditionDecorativeOverlayInfoElement Rain = new SpawnConditionDecorativeOverlayInfoElement("Images/MapBGOverlay2", (Color?)new Color(200, 200, 200))
				{
					DisplayPriority = 1f
				};
		...
		public static List<IBestiaryInfoElement> GetCommonInfoElementsForFilters()
		{
			return new List<IBestiaryInfoElement>
			{
			...
			}.Concat(from mod in Terraria.ModLoader.ModLoader.Mods
				where NPCLoader.npcs.Any((ModNPC npc) => npc.Mod == mod)
				...
				select biome.ModBiomeBestiaryInfoElement).ToList();
		}
	}
	...
	private void ModifyEntriesThatNeedIt()
	{
		...
		foreach (NPCStatsReportInfoElement item6 in from x in FindEntryByNPCID(13).Info
			select x as NPCStatsReportInfoElement into x
			where x != null
			select x)
		{
			item6.OnRefreshStats += AdjustEaterOfWorldStats;
		}
		foreach (NPCStatsReportInfoElement item7 in from x in FindEntryByNPCID(491).Info
			select x as NPCStatsReportInfoElement into x
			where x != null
			select x)
		{
			item7.OnRefreshStats += AdjustPirateShipStats;
		}
	...
	private void AddEmptyEntries_CrittersAndEnemies_Automated()
	{
		...
		foreach (KeyValuePair<int, NPC> item in ContentSamples.NpcsByNetId)
		{
			...
			{
				NPCLoader.SetBestiary(bestiaryEntry: item.Value.CountsAsACritter ? Register(BestiaryEntry.Critter(item.Key)) : ((!item.Value.isLikeATownNPC) ? Register(BestiaryEntry.Enemy(item.Key)) : Register(BestiaryEntry.TownNPC(item.Key))), npc: item.Value, database: _currentDatabase);
			}
		}
	}

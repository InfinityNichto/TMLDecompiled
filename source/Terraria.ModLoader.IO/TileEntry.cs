...
public class TileEntry : ModEntry
{
	...
	public TileEntry(ModTile tile)
		: base(tile)
	{
		frameImportant = Main.tileFrameImportant[tile.Type];
	}

	public TileEntry(TagCompound tag)
		: base(tag)
	{
	...
	public override TagCompound SerializeData()
	{
		...
		tagCompound["framed"] = frameImportant;
		return tagCompound;
	}
	...
	protected override string GetUnloadedType(ushort type)
	{
		...
		if (TileID.Sets.RoomNeeds.CountsAsChair.Contains(type) || TileID.Sets.RoomNeeds.CountsAsDoor.Contains(type) || TileID.Sets.RoomNeeds.CountsAsTable.Contains(type) || TileID.Sets.RoomNeeds.CountsAsTorch.Contains(type))
		{

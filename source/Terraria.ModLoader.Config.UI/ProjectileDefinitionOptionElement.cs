...
{
	public ProjectileDefinitionOptionElement(ProjectileDefinition definition, float scale = 0.75f)
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		if (base.Definition != null)
		{
			...
			spriteBatch.Draw(projectileTexture, position2, (Rectangle?)rectangle2, Color.White, 0f, origin, drawScale, (SpriteEffects)0, 0f);
		}

...
internal class UIInfoMessage : UIState, IHaveBackButtonCommand
{
	...
	public override void OnInitialize()
	{
		...
		_button = new UITextPanel<string>(Language.GetTextValue("tModLoader.OK"), 0.7f, large: true)
		{
			Width = 
			{
				Pixels = -10f,
		...
		_buttonAlt = new UITextPanel<string>("???", 0.7f, large: true)
		{
			Width = 
			{
				Pixels = -10f,
	...
	public override void OnActivate()
	{
		...
		_button.Left.Percent = (showAlt ? 0f : 0.25f);
	...
	internal void Show(string message, int gotoMenu, UIState gotoState = null, string altButtonText = "", Action altButtonAction = null, string okButtonText = null)
	{
		if (!Program.IsMainThread)
		{
			...
			{
				Show(message, gotoMenu, gotoState, altButtonText, altButtonAction, okButtonText);
			});
			return;
		}
		_message = message;

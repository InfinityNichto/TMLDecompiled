...
internal class UIFocusInputTextField : UIElement
{
	...
	public override void Update(GameTime gameTime)
	{
		...
		((Vector2)(ref MousePosition))._002Ector((float)Main.mouseX, (float)Main.mouseY);
	...
	private static bool JustPressed(Keys key)
	{
		...
		if (((KeyboardState)(ref Main.inputText)).IsKeyDown(key))
		{
			return !((KeyboardState)(ref Main.oldInputText)).IsKeyDown(key);
		}
		return false;
	}

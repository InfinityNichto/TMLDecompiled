...
public sealed class TEDisplayDoll : TileEntity, IFixLoadedData
{
	...
	public void Draw(int tileLeftX, int tileTopY)
	{
		...
		Vector2 position = new Vector2((float)(tileLeftX + 1), (float)(tileTopY + 3)) * 16f + new Vector2((float)(-dollPlayer.width / 2), (float)(-dollPlayer.height - 6));
	...
	public override void NetReceive(BinaryReader reader)
	{
		...
		for (int i = 0; i < 8; i++)
		{
			_dyes[i] = (presentDyes[i] ? ItemIO.Receive(reader, readStack: true) : new Item());
		}
	}
}

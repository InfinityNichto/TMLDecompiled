...
public class TriggersSet
{
	...
	public Vector2 DirectionsRaw => new Vector2((float)(Right.ToInt() - Left.ToInt()), (float)(Down.ToInt() - Up.ToInt()));
	...
	public void SetupKeys()
	{
		...
		{
			KeyStatus.Add(keybind.FullName, value: false);
		}
	}
	...
	public Vector2 GetNavigatorDirections()
	{
		...
		bool value4 = Right || (flag && MenuRight);
		bool value2 = Down || (flag && MenuDown);
		bool value3 = Left || (flag && MenuLeft);

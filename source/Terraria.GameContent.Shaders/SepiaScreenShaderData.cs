...
public class SepiaScreenShaderData : ScreenShaderData
{
	...
	public override void Update(GameTime gameTime)
	{
		...
		((Vector3)(ref value))._002Ector(0.191f, -0.054f, -0.221f);
		Vector3 val = value;
		Vector3 value2 = val * 0.5f;
		Vector3 value3 = default(Vector3);
		((Vector3)(ref value3))._002Ector(0f, -0.03f, 0.15f);
		Vector3 value4 = default(Vector3);
		((Vector3)(ref value4))._002Ector(-0.11f, 0.01f, 0.16f);
		...
		else if (!Main.dayTime)
		{
			...
			{
				((Vector3)(ref value))._002Ector(-0.19f, 0.01f, 0.22f);
				num2 += 0.07f * moonPower;
			}
			if (Main.bloodMoon)
			{
				((Vector3)(ref value))._002Ector(0.2f, -0.1f, -0.221f);
				num2 = 0.2f;
			}
		}
		nightlightPower *= num;
		...
		UseProgress(value5);
		Vector3 value7 = Vector3.Lerp(val, value, moonPower);

...
public class UILinkPointNavigator
{
	...
	public static void Update()
	{
		...
		InUse = false;
		bool flag = true;
		if (flag && (uint)PlayerInput.CurrentInputMode <= 2u && !Main.gameMenu)
		{
			flag = false;
		}
		...
		bool num4 = PlayerInput.Triggers.Current.HotbarMinus && !PlayerInput.Triggers.Current.HotbarPlus;
		...
		if (PlayerInput.Triggers.Current.UsedMovementKey)
		{
			...
			Vector2 vector = Vector2.Lerp(val, position, amount);
			if (Main.gameMenu)
			{

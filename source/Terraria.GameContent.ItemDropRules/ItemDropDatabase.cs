...
public class ItemDropDatabase
{
	...
	public void Populate()
	{
		...
		foreach (KeyValuePair<int, NPC> pair2 in ContentSamples.NpcsByNetId)
		{
			NPCLoader.ModifyNPCLoot(pair2.Value, new NPCLoot(pair2.Key, this));
		}
	...
	private void RegisterEclipse()
	{
		...
		IItemDropRule rule3 = RegisterToNPC(477, new LeadingConditionRule(condition));
		IItemDropRule rule2 = rule3.OnSuccess(new LeadingConditionRule(condition2));
		rule3.OnSuccess(ItemDropRule.ExpertGetsRerolls(1570, 4, 1));
	...
	private void RegisterMiscDrops()
	{
		...
		int[] npcNetIds12 = new int[3] { 198, 199, 226 };
		RegisterToMultipleNPCs(ItemDropRule.Common(1172, 1000), npcNetIds12);
		RegisterToMultipleNPCs(ItemDropRule.Common(1293, 50), npcNetIds12);
		RegisterToMultipleNPCs(ItemDropRule.Common(2766, 7, 1, 2), npcNetIds12);
		int[] npcNetIds15 = new int[4] { 78, 79, 80, 630 };
		RegisterToMultipleNPCs(ItemDropRule.Common(870, 75), npcNetIds15);
		RegisterToMultipleNPCs(ItemDropRule.Common(871, 75), npcNetIds15);
		RegisterToMultipleNPCs(ItemDropRule.Common(872, 75), npcNetIds15);
		...
		int[] npcNetIds16 = new int[3] { 473, 474, 475 };
		RegisterToMultipleNPCs(ItemDropRule.Common(499, 1, 5, 10), npcNetIds16);
		RegisterToMultipleNPCs(ItemDropRule.Common(500, 1, 5, 15), npcNetIds16);
		...
		int[] npcNetIds17 = new int[3] { 143, 144, 145 };
		RegisterToMultipleNPCs(ItemDropRule.Common(593, 1, 5, 10), npcNetIds17);
		...
		RegisterToMultipleNPCs(ItemDropRule.Common(18, 80), npcNetIds18).OnFailedRoll(ItemDropRule.Common(393, 80)).OnFailedRoll(ItemDropRule.Common(3285, 25));
		int[] npcNetIds19 = new int[12]
		{
			21, 201, 202, 203, 322, 323, 324, 635, 449, 450,
			451, 452
		};
		RegisterToMultipleNPCs(ItemDropRule.Common(954, 100), npcNetIds19).OnFailedRoll(ItemDropRule.Common(955, 200)).OnFailedRoll(ItemDropRule.Common(1166, 200)).OnFailedRoll(ItemDropRule.Common(1274, 500));
		RegisterToNPC(6, ItemDropRule.OneFromOptions(175, 956, 957, 958));
		int[] npcNetIds20 = new int[7] { 42, 43, 231, 232, 233, 234, 235 };
		RegisterToMultipleNPCs(ItemDropRule.OneFromOptions(100, 960, 961, 962), npcNetIds20);
		int[] npcNetIds21 = new int[5] { 31, 32, 294, 295, 296 };
		RegisterToMultipleNPCs(ItemDropRule.Common(959, 450), npcNetIds21);
		RegisterToMultipleNPCs(ItemDropRule.Common(1307, 300), npcNetIds21);
		...
		int[] npcNetIds2 = new int[4] { 335, 336, 333, 334 };
		RegisterToMultipleNPCs(ItemDropRule.Common(1906, 20), npcNetIds2);
		RegisterToNPC(-4, ItemDropRule.Common(3111, 1, 25, 50));
		RegisterToNPC(-4, ItemDropRule.NormalvsExpert(1309, 100, 70));
		int[] npcNetIds3 = new int[18]
		{
			1, 16, 138, 141, 147, 184, 187, 433, 204, 302,
			333, 334, 335, 336, 535, 658, 659, 660
		};
		int[] npcNetIds4 = new int[4] { -6, -7, -8, -9 };
		int[] npcNetIds5 = new int[5] { -6, -7, -8, -9, -4 };
		IItemDropRule entry = RegisterToMultipleNPCs(ItemDropRule.Common(23, 1, 1, 2), npcNetIds3);
		RemoveFromMultipleNPCs(entry, npcNetIds5);
		RegisterToMultipleNPCs(ItemDropRule.Common(23, 1, 2, 5), npcNetIds4);
		IItemDropRule entry2 = RegisterToMultipleNPCs(ItemDropRule.NormalvsExpert(1309, 10000, 7000), npcNetIds3);
		RemoveFromMultipleNPCs(entry2, npcNetIds5);
		RegisterToMultipleNPCs(ItemDropRule.NormalvsExpert(1309, 10000, 7000), npcNetIds4);
		...
		int[] npcNetIds6 = new int[9] { 2, 317, 318, 190, 191, 192, 193, 194, 133 };
		RegisterToMultipleNPCs(ItemDropRule.Common(236, 100), npcNetIds6).OnFailedRoll(ItemDropRule.Common(38, 3));
		...
		int[] npcNetIds7 = new int[23]
		{
			3, 591, 590, 331, 332, 132, 161, 186, 187, 188,
			189, 200, 223, 319, 320, 321, 430, 431, 432, 433,
			434, 435, 436
		};
		RegisterToMultipleNPCs(ItemDropRule.Common(216, 50), npcNetIds7);
		RegisterToMultipleNPCs(ItemDropRule.Common(1304, 250), npcNetIds7);
		RegisterToMultipleNPCs(ItemDropRule.Common(5332, 1500), npcNetIds7);
		...
		int[] npcNetIds8 = new int[2] { 483, 482 };
		RegisterToMultipleNPCs(ItemDropRule.Common(3109, 30), npcNetIds8);
		RegisterToMultipleNPCs(ItemDropRule.Common(4400, 20), npcNetIds8);
		...
		int[] npcNetIds9 = new int[3] { 63, 103, 64 };
		RegisterToMultipleNPCs(ItemDropRule.Common(1303, 100), npcNetIds9);
		RegisterToMultipleNPCs(ItemDropRule.Common(282, 1, 1, 4), npcNetIds9);
		...
		int[] npcNetIds10 = new int[13]
		{
			21, 167, 201, 202, 481, 203, 322, 323, 324, 449,
			450, 451, 452
		};
		RegisterToMultipleNPCs(ItemDropRule.Common(118, 25), npcNetIds10);
		...
		int[] npcNetIds11 = new int[6] { 31, 32, 34, 294, 295, 296 };
		RegisterToMultipleNPCs(ItemDropRule.Common(932, 250), npcNetIds11).OnFailedRoll(ItemDropRule.Common(3095, 100)).OnFailedRoll(ItemDropRule.Common(327, 65)).OnFailedRoll(ItemDropRule.ByCondition(new Conditions.NotExpert(), 154, 1, 1, 3));
		RegisterToMultipleNPCs(ItemDropRule.ByCondition(new Conditions.IsExpert(), 154, 1, 2, 6), npcNetIds11);
		int[] npcNetIds13 = new int[5] { 26, 27, 28, 29, 111 };
		RegisterToMultipleNPCs(ItemDropRule.Common(160, 200), npcNetIds13).OnFailedRoll(ItemDropRule.Common(161, 2, 1, 5));
		...
		RegisterToMultipleNPCs(leadingConditionRule, npcNetIds14);
	}

	public List<IItemDropRule> GetRulesForItemID(int itemID)
	{
		List<IItemDropRule> list = new List<IItemDropRule>();
		if (_entriesByItemId.TryGetValue(itemID, out var value))
		{
			list.AddRange(value);
		}
		return list;
	...
	public IItemDropRule RegisterToItem(int type, IItemDropRule entry)
	{
		...
		if (type > 0 && _itemIdsByType.TryGetValue(type, out var value))
		{
			for (int i = 0; i < value.Count; i++)
			{
	...
	{
		short item = 4957;
		RegisterToItem(item, ItemDropRule.Common(4987));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(4986, 1, 25, 74));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(4959, 7));
		...
		RegisterToItem(item, ItemDropRule.FewFromOptionsNotScalingWithLuckWithX(2, 1, 1, 4982, 4983, 4984));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(657));
		item = 4782;
		RegisterToItem(item, ItemDropRule.Common(4989));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(4784, 7));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(4823, 10));
		...
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(5075, 20));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(636));
		item = 3318;
		RegisterToItem(item, ItemDropRule.Common(3090));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2493, 7));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2430, 2));
		RegisterToItem(item, ItemDropRule.FewFromOptionsNotScalingWithLuckWithX(2, 1, 1, 256, 257, 258));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 2610, 2585));
		RegisterToItem(item, ItemDropRule.Common(998));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(50));
		item = 3328;
		RegisterToItem(item, ItemDropRule.Common(3336));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2109, 7));
		RegisterToItem(item, ItemDropRule.Common(1141));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(1182, 15));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(1305, 20));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(1157, 2));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(3021, 10));
		IItemDropRule itemDropRuleGrenadeLauncher = ItemDropRule.Common(758);
		itemDropRuleGrenadeLauncher.OnSuccess(ItemDropRule.Common(771, 1, 50, 149), hideLootReport: true);
		...
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(262));
		item = 3327;
		RegisterToItem(item, ItemDropRule.Common(3356));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2107, 7));
		RegisterToItem(item, ItemDropRule.Common(547, 1, 25, 40));
		RegisterToItem(item, ItemDropRule.Common(1225, 1, 20, 35));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(127));
		item = 3325;
		RegisterToItem(item, ItemDropRule.Common(3355));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2113, 7));
		RegisterToItem(item, ItemDropRule.Common(548, 1, 25, 40));
		RegisterToItem(item, ItemDropRule.Common(1225, 1, 20, 35));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(134));
		item = 3326;
		RegisterToItem(item, ItemDropRule.Common(3354));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2106, 7));
		RegisterToItem(item, ItemDropRule.Common(549, 1, 25, 40));
		RegisterToItem(item, ItemDropRule.Common(1225, 1, 20, 35));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(125));
		item = 3319;
		...
		RegisterToItem(item, ItemDropRule.Common(3097));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2112, 7));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(1299, 30));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsCrimson, 880, 1, 30, 87));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsCrimson, 2171, 1, 1, 3));
		...
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(4));
		item = 3321;
		...
		RegisterToItem(item, ItemDropRule.Common(3223));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2104, 7));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsNotMaster, 880, 1, 80, 110));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsNotMaster, 1329, 1, 20, 40));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsMaster, 880, 1, 110, 135));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsMaster, 1329, 1, 30, 50));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(3060, 20));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(266));
		item = 3320;
		RegisterToItem(item, ItemDropRule.Common(3224));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2111, 7));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsNotMaster, 56, 1, 80, 110));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsNotMaster, 86, 1, 20, 40));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsMaster, 56, 1, 110, 135));
		RegisterToItem(item, ItemDropRule.ByCondition(conditionIsMaster, 86, 1, 30, 50));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(994, 20));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(13));
		item = 5111;
		RegisterToItem(item, ItemDropRule.Common(5100));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(5109, 7));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(5385, 14));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(5098, 3));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(5101, 3));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(5113, 3));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 5117, 5118, 5119, 5095));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(668));
		item = 3322;
		RegisterToItem(item, ItemDropRule.Common(3333));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2108, 7));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 1121, 1123, 2888));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(1132, 3));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(1170, 9));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2502, 9));
		RegisterToItem(item, ItemDropRule.Common(1129));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 842, 843, 844));
		RegisterToItem(item, ItemDropRule.Common(1130, 1, 10, 29));
		RegisterToItem(item, ItemDropRule.Common(2431, 1, 17, 29));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(222));
		item = 3323;
		RegisterToItem(item, ItemDropRule.Common(3245));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 1281, 1273, 1313));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(35));
		item = 3324;
		RegisterToItem(item, ItemDropRule.ByCondition(new Conditions.NotUsedDemonHeart(), 3335));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2105, 7));
		RegisterToItem(item, ItemDropRule.Common(367));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 2998, 489, 490, 491));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 514, 426, 434, 4912));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(113));
		item = 3331;
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(3372, 7));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(439));
		item = 3332;
		RegisterToItem(item, ItemDropRule.Common(1131));
		RegisterToItem(item, ItemDropRule.Common(3577));
		RegisterToItem(item, ItemDropRule.Common(4954));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(3373, 7));
		RegisterToItem(item, ItemDropRule.Common(3460, 1, 90, 110));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(4469, 10));
		RegisterToItem(item, ItemDropRule.ByCondition(new Conditions.NoPortalGun(), 3384));
		RegisterToItem(item, new FromOptionsWithoutRepeatsDropRule(2, 3063, 3389, 3065, 1553, 3930, 3541, 3570, 3571, 3569));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(398));
		item = 3860;
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(3863, 7));
		RegisterToItem(item, ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 3827, 3859, 3870, 3858));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(3883, 4));
		RegisterToItem(item, ItemDropRule.Common(3817, 1, 30, 49));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(551));
		item = 3329;
		RegisterToItem(item, ItemDropRule.Common(3337));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2110, 7));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(1294, 3));
		IItemDropRule itemDropRuleStynger = ItemDropRule.Common(1258);
		itemDropRuleStynger.OnSuccess(ItemDropRule.Common(1261, 1, 60, 99), hideLootReport: true);
		...
		RegisterToItem(item, ItemDropRule.Common(2218, 1, 18, 23));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(245));
		item = 3330;
		RegisterToItem(item, ItemDropRule.Common(3367));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2588, 7));
		RegisterToItem(item, ItemDropRule.NotScalingWithLuck(2609, 10));
		RegisterToItem(item, new LeadingConditionRule(new Conditions.NotRemixSeed())).OnSuccess(ItemDropRule.OneFromOptions(1, 2611, 2624, 2622, 2621, 2623));
		RegisterToItem(item, new LeadingConditionRule(new Conditions.RemixSeed())).OnSuccess(ItemDropRule.OneFromOptions(1, 2611, 2624, 2622, 2621, 157));
		RegisterToItem(item, ItemDropRule.CoinsBasedOnNPCValue(370));
	}

	private void RegisterCrateDrops()
	{
		IItemDropRule[] themed = new IItemDropRule[3]
		{
			ItemDropRule.NotScalingWithLuck(3200, 40),
			ItemDropRule.NotScalingWithLuck(3201, 40),
			ItemDropRule.NotScalingWithLuck(997, 50)
		};
		IItemDropRule[] hardmodeThemed = new IItemDropRule[4]
		{
			ItemDropRule.ByCondition(new Conditions.IsHardmode(), 3064, 200),
			ItemDropRule.NotScalingWithLuck(3200, 40),
			ItemDropRule.NotScalingWithLuck(3201, 40),
			ItemDropRule.NotScalingWithLuck(2424, 25)
		};
		IItemDropRule[] coin = new IItemDropRule[2]
		{
		...
		IItemDropRule[] bars = new IItemDropRule[4]
		{
		...
		IItemDropRule[] potions = new IItemDropRule[10]
		{
		...
		IItemDropRule bc_surfaceLoot = ItemDropRule.OneFromOptionsNotScalingWithLuck(20, 285, 953, 4341, 3068, 3084);
		IItemDropRule[] woodenCrateDrop = new IItemDropRule[5]
		{
		...
		IItemDropRule[] pearlwoodCrateDrop = new IItemDropRule[5]
		{
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, hardmodeThemed),
			bc_surfaceLoot,
			ItemDropRule.SequentialRulesNotScalingWithLuck(7, coin),
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, ItemDropRule.SequentialRulesNotScalingWithLuck(7, new OneFromRulesRule(2, hardmodeOres), new OneFromRulesRule(1, ores)), ItemDropRule.SequentialRulesNotScalingWithLuck(8, new OneFromRulesRule(2, hardmodeBars), new OneFromRulesRule(1, bars))),
			new OneFromRulesRule(7, potions)
		};
		RegisterToItem(2334, ItemDropRule.AlwaysAtleastOneSuccess(woodenCrateDrop));
		RegisterToItem(3979, ItemDropRule.AlwaysAtleastOneSuccess(pearlwoodCrateDrop));
		RegisterToMultipleItems(new OneFromRulesRule(3, extraPotions), 2334, 3979);
		RegisterToMultipleItems(ItemDropRule.SequentialRulesNotScalingWithLuck(3, extraBait), 2334, 3979);
		themed = new IItemDropRule[5]
		{
			ItemDropRule.NotScalingWithLuck(2501, 25),
			ItemDropRule.NotScalingWithLuck(2587, 20),
			ItemDropRule.NotScalingWithLuck(2608, 15),
			ItemDropRule.NotScalingWithLuck(3200, 20),
			ItemDropRule.NotScalingWithLuck(3201, 20)
		};
		hardmodeThemed = new IItemDropRule[6]
		{
			ItemDropRule.ByCondition(new Conditions.IsHardmode(), 3064, 60),
			ItemDropRule.NotScalingWithLuck(2501, 25),
			ItemDropRule.NotScalingWithLuck(2587, 20),
			ItemDropRule.NotScalingWithLuck(2608, 15),
			ItemDropRule.NotScalingWithLuck(3200, 20),
		...
		hardmodeOres = new IItemDropRule[4]
		{
		...
		hardmodeBars = new IItemDropRule[4]
		{
		...
		IItemDropRule[] mythrilCrate = new IItemDropRule[4]
		{
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, hardmodeThemed),
			ItemDropRule.NotScalingWithLuck(73, 4, 5, 10),
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, ItemDropRule.SequentialRulesNotScalingWithLuck(6, new OneFromRulesRule(2, hardmodeOres), new OneFromRulesRule(1, ores)), ItemDropRule.SequentialRulesNotScalingWithLuck(4, new OneFromRulesRule(3, 2, hardmodeBars), new OneFromRulesRule(1, bars))),
			new OneFromRulesRule(4, potions)
		};
		RegisterToItem(2335, ItemDropRule.AlwaysAtleastOneSuccess(ironCrate));
		RegisterToItem(3980, ItemDropRule.AlwaysAtleastOneSuccess(mythrilCrate));
		RegisterToMultipleItems(new OneFromRulesRule(2, extraPotions), 2335, 3980);
		RegisterToMultipleItems(ItemDropRule.SequentialRulesNotScalingWithLuck(2, extraBait), 2335, 3980);
		themed = new IItemDropRule[2]
		{
			ItemDropRule.NotScalingWithLuck(29, 8),
			ItemDropRule.NotScalingWithLuck(2491, 10)
		};
		hardmodeThemed = new IItemDropRule[3]
		{
			ItemDropRule.ByCondition(new Conditions.IsHardmode(), 3064, 20),
			ItemDropRule.NotScalingWithLuck(29, 8),
			ItemDropRule.NotScalingWithLuck(2491, 10)
		};
		ores = new IItemDropRule[4]
		{
		...
		IItemDropRule[] goldCrate = new IItemDropRule[5]
		{
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, themed),
			...
			ItemDropRule.NotScalingWithLuck(989, 30)
		};
		IItemDropRule[] titaniumCrate = new IItemDropRule[5]
		{
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, hardmodeThemed),
			ItemDropRule.NotScalingWithLuck(73, 3, 8, 20),
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, ItemDropRule.SequentialRulesNotScalingWithLuck(5, new OneFromRulesRule(2, hardmodeOres), new OneFromRulesRule(1, ores)), ItemDropRule.SequentialRulesNotScalingWithLuckWithNumerator(3, 2, new OneFromRulesRule(3, 2, hardmodeBars), new OneFromRulesRule(1, bars))),
			new OneFromRulesRule(3, potions),
			ItemDropRule.NotScalingWithLuck(989, 15)
		};
		RegisterToItem(2336, ItemDropRule.AlwaysAtleastOneSuccess(goldCrate));
		RegisterToItem(3981, ItemDropRule.AlwaysAtleastOneSuccess(titaniumCrate));
		RegisterToMultipleItems(new OneFromRulesRule(2, extraPotions), 2336, 3981);
		RegisterToMultipleItems(new CommonDrop(2676, 3, 3, 7, 2), 2336, 3981);
		IItemDropRule[] bc_jungle = new IItemDropRule[2]
		{
			ItemDropRule.NotScalingWithLuck(3017, 20),
			ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 212, 964, 211, 213, 2292)
		};
		IItemDropRule bc_bamboo = ItemDropRule.NotScalingWithLuck(4564, 3, 20, 50);
		IItemDropRule bc_seaweed = ItemDropRule.NotScalingWithLuck(753, 20);
		IItemDropRule bc_sky = ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 158, 2219, 65, 159);
		IItemDropRule bc_cloud = ItemDropRule.NotScalingWithLuck(751, 2, 50, 100);
		IItemDropRule bc_fledgeWings = ItemDropRule.NotScalingWithLuck(4978, 40);
		IItemDropRule bc_skyPaintings = ItemDropRule.OneFromOptionsNotScalingWithLuck(2, 5226, 5254, 5238, 5258, 5255, 5388);
		IItemDropRule bc_son = ItemDropRule.NotScalingWithLuck(521, 2, 2, 5);
		IItemDropRule bc_corrupt = ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 162, 111, 96, 115, 64);
		IItemDropRule bc_crimson = ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 800, 802, 1256, 1290, 3062);
		...
		IItemDropRule bc_lockbox = ItemDropRule.Common(3085);
		...
		IItemDropRule[] bc_iceList = new IItemDropRule[6]
		{
		...
		IItemDropRule bc_fish = ItemDropRule.NotScalingWithLuck(669, 20);
		IItemDropRule bc_scarab = ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 4056, 4442, 4055, 4061, 4062, 4276, 4262, 4263);
		...
		IItemDropRule bc_sandstormBottle = ItemDropRule.NotScalingWithLuck(857, 35);
		IItemDropRule[] bc_lava = new IItemDropRule[2]
		{
			ItemDropRule.NotScalingWithLuck(906, 20),
			ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 4822, 4828, 4880, 4881, 4868)
		};
		IItemDropRule bc_pot = ItemDropRule.NotScalingWithLuck(4858, 4, 2, 2);
		IItemDropRule bc_obsi = ItemDropRule.Common(4879);
		IItemDropRule bc_wet = ItemDropRule.NotScalingWithLuck(4824, 3, 7, 10);
		IItemDropRule bc_plant = ItemDropRule.OneFromOptionsNotScalingWithLuck(2, 4902, 4903, 4904, 4905, 4906);
		IItemDropRule bc_ornate = ItemDropRule.NotScalingWithLuck(4737, 20);
		IItemDropRule bc_hellcart = ItemDropRule.NotScalingWithLuck(4443, 20);
		IItemDropRule bc_cake = ItemDropRule.NotScalingWithLuck(4551, 20);
		IItemDropRule[] bc_sea = new IItemDropRule[2]
		{
			ItemDropRule.NotScalingWithLuck(863, 10),
			ItemDropRule.OneFromOptionsNotScalingWithLuck(1, 186, 4404, 277, 187)
		};
		IItemDropRule bc_pile = ItemDropRule.NotScalingWithLuck(4090, 3, 20, 50);
		IItemDropRule bc_sharkbait = ItemDropRule.NotScalingWithLuck(4425, 10);
		IItemDropRule bc_sand = ItemDropRule.NotScalingWithLuck(4460, 10);
		IItemDropRule bc_goldCoin = ItemDropRule.NotScalingWithLuck(73, 4, 5, 12);
		ores = new IItemDropRule[8]
		{
		...
		hardmodeOres = new IItemDropRule[6]
		{
		...
		hardmodeBars = new IItemDropRule[6]
		{
		...
		IItemDropRule[] jungle = new IItemDropRule[7]
		{
		...
		IItemDropRule[] bramble = new IItemDropRule[7]
		{
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, bc_jungle),
			bc_goldCoin,
		...
		IItemDropRule[] sky = new IItemDropRule[8]
		{
			bc_sky,
			bc_fledgeWings,
			bc_cloud,
		...
		IItemDropRule[] azure = new IItemDropRule[8]
		{
			bc_sky,
			bc_fledgeWings,
			bc_cloud,
		...
		IItemDropRule[] corrupt = new IItemDropRule[5]
		{
			bc_corrupt,
			bc_goldCoin,
			new OneFromRulesRule(7, ores),
		...
		IItemDropRule[] defiled = new IItemDropRule[7]
		{
			bc_corrupt,
			bc_goldCoin,
			hardmodeBiomeCrateOres,
		...
		IItemDropRule[] crimson = new IItemDropRule[5]
		{
			bc_crimson,
			bc_goldCoin,
			new OneFromRulesRule(7, ores),
		...
		IItemDropRule[] hematic = new IItemDropRule[7]
		{
			bc_crimson,
			bc_goldCoin,
			hardmodeBiomeCrateOres,
		...
		IItemDropRule[] hallowed = new IItemDropRule[4]
		{
			bc_goldCoin,
			new OneFromRulesRule(7, ores),
			new OneFromRulesRule(4, bars),
		...
		IItemDropRule[] divine = new IItemDropRule[6]
		{
			bc_goldCoin,
			hardmodeBiomeCrateOres,
			hardmodeBiomeCrateBars,
		...
		IItemDropRule[] dungeon = new IItemDropRule[6]
		{
			bc_lockbox,
			bc_book,
			bc_goldCoin,
		...
		IItemDropRule[] stockade = new IItemDropRule[6]
		{
			bc_lockbox,
			bc_book,
			bc_goldCoin,
		...
		IItemDropRule[] frozen = new IItemDropRule[6]
		{
			bc_ice,
			bc_goldCoin,
			new OneFromRulesRule(7, ores),
		...
		IItemDropRule[] boreal = new IItemDropRule[6]
		{
			bc_ice,
			bc_goldCoin,
			hardmodeBiomeCrateOres,
		...
		IItemDropRule[] oasis = new IItemDropRule[8]
		{
			bc_scarab,
			bc_bomb,
			bc_sandstormBottle,
		...
		IItemDropRule[] mirage = new IItemDropRule[8]
		{
			bc_scarab,
			bc_bomb,
			bc_sandstormBottle,
		...
		IItemDropRule[] obsidian = new IItemDropRule[12]
		{
		...
		IItemDropRule[] hellstone = new IItemDropRule[12]
		{
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, bc_lava),
			bc_pot,
			bc_obsi,
		...
		IItemDropRule[] ocean = new IItemDropRule[8]
		{
		...
		IItemDropRule[] seaside = new IItemDropRule[8]
		{
			ItemDropRule.SequentialRulesNotScalingWithLuck(1, bc_sea),
			bc_sharkbait,
			bc_goldCoin,
		...
		RegisterToItem(3208, ItemDropRule.AlwaysAtleastOneSuccess(jungle));
		RegisterToItem(3987, ItemDropRule.AlwaysAtleastOneSuccess(bramble));
		RegisterToItem(3206, ItemDropRule.AlwaysAtleastOneSuccess(sky));
		RegisterToItem(3985, ItemDropRule.AlwaysAtleastOneSuccess(azure));
		RegisterToItem(3203, ItemDropRule.AlwaysAtleastOneSuccess(corrupt));
		RegisterToItem(3982, ItemDropRule.AlwaysAtleastOneSuccess(defiled));
		RegisterToItem(3204, ItemDropRule.AlwaysAtleastOneSuccess(crimson));
		RegisterToItem(3983, ItemDropRule.AlwaysAtleastOneSuccess(hematic));
		RegisterToItem(3207, ItemDropRule.AlwaysAtleastOneSuccess(hallowed));
		RegisterToItem(3986, ItemDropRule.AlwaysAtleastOneSuccess(divine));
		RegisterToItem(3205, ItemDropRule.AlwaysAtleastOneSuccess(dungeon));
		RegisterToItem(3984, ItemDropRule.AlwaysAtleastOneSuccess(stockade));
		RegisterToItem(4405, ItemDropRule.AlwaysAtleastOneSuccess(frozen));
		RegisterToItem(4406, ItemDropRule.AlwaysAtleastOneSuccess(boreal));
		RegisterToItem(4407, ItemDropRule.AlwaysAtleastOneSuccess(oasis));
		RegisterToItem(4408, ItemDropRule.AlwaysAtleastOneSuccess(mirage));
		RegisterToItem(4877, ItemDropRule.AlwaysAtleastOneSuccess(obsidian));
		RegisterToItem(4878, ItemDropRule.AlwaysAtleastOneSuccess(hellstone));
		RegisterToItem(5002, ItemDropRule.AlwaysAtleastOneSuccess(ocean));
		RegisterToItem(5003, ItemDropRule.AlwaysAtleastOneSuccess(seaside));
		int[] allCrates = new int[20]
		{
			3208, 3987, 3206, 3985, 3203, 3982, 3204, 3983, 3207, 3986,
			3205, 3984, 4405, 4406, 4407, 4408, 4877, 4878, 5002, 5003
		};
	...
	{
		IItemDropRule ruleFlowerOfFireUnholyTrident = ItemDropRule.ByCondition(new Conditions.NotRemixSeed(), 112);
		ruleFlowerOfFireUnholyTrident.OnFailedConditions(ItemDropRule.NotScalingWithLuck(683), hideLootReport: true);
		IItemDropRule[] obsidianLockBoxList = new IItemDropRule[5]
		{
			ItemDropRule.NotScalingWithLuck(274),
			ItemDropRule.NotScalingWithLuck(220),
			ruleFlowerOfFireUnholyTrident,
			ItemDropRule.NotScalingWithLuck(218),
			ItemDropRule.NotScalingWithLuck(3019)
		};
		RegisterToItem(4879, new OneFromRulesRule(1, obsidianLockBoxList));
		RegisterToItem(4879, ItemDropRule.NotScalingWithLuck(5010, 5));
	}

	private void RegisterLockbox()
	{
		IItemDropRule ruleAquaScepterBubbleGun = ItemDropRule.ByCondition(new Conditions.NotRemixSeed(), 157);
		ruleAquaScepterBubbleGun.OnFailedConditions(ItemDropRule.NotScalingWithLuck(2623), hideLootReport: true);
		IItemDropRule[] goldenLockBoxList = new IItemDropRule[7]
		{
			ItemDropRule.NotScalingWithLuck(3317),
			ItemDropRule.NotScalingWithLuck(155),
			ItemDropRule.NotScalingWithLuck(156),
			ruleAquaScepterBubbleGun,
			ItemDropRule.NotScalingWithLuck(163),
			ItemDropRule.NotScalingWithLuck(113),
			ItemDropRule.NotScalingWithLuck(164)
		};
		RegisterToItem(3085, new OneFromRulesRule(1, goldenLockBoxList));
		RegisterToItem(3085, ItemDropRule.NotScalingWithLuck(329, 3));
	}

	private void RegisterHerbBag()
	{
		RegisterToItem(3093, new HerbBagDropsItemDropRule(313, 314, 315, 317, 316, 318, 2358, 307, 308, 309, 311, 310, 312, 2357));
	}

	private void RegisterGoodieBag()
	{
		IItemDropRule[] paintings = new IItemDropRule[5]
		{
			ItemDropRule.NotScalingWithLuck(1846),
			ItemDropRule.NotScalingWithLuck(1847),
			ItemDropRule.NotScalingWithLuck(1848),
			ItemDropRule.NotScalingWithLuck(1849),
			ItemDropRule.NotScalingWithLuck(1850)
		};
		IItemDropRule catSet = ItemDropRule.NotScalingWithLuck(1749);
		catSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1750));
		catSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1751));
		IItemDropRule creeperSet = ItemDropRule.NotScalingWithLuck(1746);
		creeperSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1747));
		creeperSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1748));
		IItemDropRule ghostSet = ItemDropRule.NotScalingWithLuck(1752);
		ghostSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1753));
		IItemDropRule leprechaunSet = ItemDropRule.NotScalingWithLuck(1767);
		leprechaunSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1768));
		leprechaunSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1769));
		IItemDropRule pixieSet = ItemDropRule.NotScalingWithLuck(1770);
		pixieSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1771));
		IItemDropRule princessSet = ItemDropRule.NotScalingWithLuck(1772);
		princessSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1773));
		IItemDropRule pumpkinSet = ItemDropRule.NotScalingWithLuck(1754);
		pumpkinSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1755));
		pumpkinSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1756));
		IItemDropRule robotSet = ItemDropRule.NotScalingWithLuck(1757);
		robotSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1758));
		robotSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1759));
		IItemDropRule unicornSet = ItemDropRule.NotScalingWithLuck(1760);
		unicornSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1761));
		unicornSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1762));
		IItemDropRule vampireSet = ItemDropRule.NotScalingWithLuck(1763);
		vampireSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1764));
		vampireSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1765));
		IItemDropRule witchSet = ItemDropRule.NotScalingWithLuck(1766);
		witchSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1775));
		witchSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1776));
		IItemDropRule aintTypingThatSet = ItemDropRule.NotScalingWithLuck(1777);
		aintTypingThatSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1778));
		IItemDropRule karateTortoiseSet = ItemDropRule.NotScalingWithLuck(1779);
		karateTortoiseSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1780));
		karateTortoiseSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1781));
		IItemDropRule reaperSet = ItemDropRule.NotScalingWithLuck(1819);
		reaperSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1820));
		IItemDropRule foxSet = ItemDropRule.NotScalingWithLuck(1821);
		foxSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1822));
		foxSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1823));
		IItemDropRule spaceCreatureSet = ItemDropRule.NotScalingWithLuck(1838);
		spaceCreatureSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1839));
		spaceCreatureSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1840));
		IItemDropRule wolfSet = ItemDropRule.NotScalingWithLuck(1841);
		wolfSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1842));
		wolfSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1843));
		IItemDropRule treasureHunterSet = ItemDropRule.NotScalingWithLuck(1851);
		treasureHunterSet.OnSuccess(ItemDropRule.NotScalingWithLuck(1852));
		IItemDropRule[] vanitySets = new IItemDropRule[19]
		{
			catSet,
			creeperSet,
			ghostSet,
			...
			reaperSet,
			foxSet,
			ItemDropRule.NotScalingWithLuck(1824),
			spaceCreatureSet,
			wolfSet,
			treasureHunterSet
		};
		IItemDropRule[] rules = new IItemDropRule[5]
		{
			ItemDropRule.NotScalingWithLuck(1810, 150),
			ItemDropRule.NotScalingWithLuck(1800, 150),
			ItemDropRule.NotScalingWithLuck(1809, 4, 10, 40),
			new OneFromRulesRule(10, paintings),
			new OneFromRulesRule(1, vanitySets)
		};
		RegisterToItem(1774, new SequentialRulesNotScalingWithLuckRule(1, rules));
	}

	private void RegisterPresent()
	{
		IItemDropRule snowGlobeRule = ItemDropRule.ByCondition(new Conditions.IsHardmode(), 602, 15);
		IItemDropRule redRyderRule = ItemDropRule.NotScalingWithLuck(1870, 150);
		redRyderRule.OnSuccess(ItemDropRule.NotScalingWithLuck(97, 1, 30, 60));
		IItemDropRule mrsClauseRule = ItemDropRule.NotScalingWithLuck(1932);
		mrsClauseRule.OnSuccess(ItemDropRule.NotScalingWithLuck(1933));
		mrsClauseRule.OnSuccess(ItemDropRule.NotScalingWithLuck(1934));
		IItemDropRule parkaRule = ItemDropRule.NotScalingWithLuck(1935);
		parkaRule.OnSuccess(ItemDropRule.NotScalingWithLuck(1936));
		parkaRule.OnSuccess(ItemDropRule.NotScalingWithLuck(1937));
		IItemDropRule treeRule = ItemDropRule.NotScalingWithLuck(1940);
		treeRule.OnSuccess(ItemDropRule.NotScalingWithLuck(1941));
		treeRule.OnSuccess(ItemDropRule.NotScalingWithLuck(1942));
		IItemDropRule[] vanityRules = new IItemDropRule[5]
		{
			mrsClauseRule,
			parkaRule,
			treeRule,
			ItemDropRule.NotScalingWithLuck(1938),
			ItemDropRule.NotScalingWithLuck(1939)
		};
		IItemDropRule vanityRule = new OneFromRulesRule(15, vanityRules);
		IItemDropRule foodRule = ItemDropRule.OneFromOptionsNotScalingWithLuck(7, 1911, 1919, 1920);
		IItemDropRule blockRule = new OneFromRulesRule(1, ItemDropRule.Common(1872, 1, 20, 49), ItemDropRule.Common(586, 1, 20, 49), ItemDropRule.Common(591, 1, 20, 49));
		IItemDropRule[] rules = new IItemDropRule[17]
		{
			snowGlobeRule,
			ItemDropRule.NotScalingWithLuck(1922, 30),
			ItemDropRule.NotScalingWithLuck(1927, 400),
			redRyderRule,
			ItemDropRule.NotScalingWithLuck(1909, 150),
			ItemDropRule.NotScalingWithLuck(1917, 150),
			ItemDropRule.NotScalingWithLuck(1915, 150),
			ItemDropRule.NotScalingWithLuck(1918, 150),
			ItemDropRule.NotScalingWithLuck(1921, 150),
			ItemDropRule.NotScalingWithLuck(1923, 300),
			ItemDropRule.NotScalingWithLuck(1907, 40),
			ItemDropRule.NotScalingWithLuck(1908, 10),
			vanityRule,
			foodRule,
		...
		RegisterToItem(1869, new SequentialRulesNotScalingWithLuckRule(1, rules));
	}

	private void RegisterCanOfWorms()
	{
		RegisterToItem(4345, ItemDropRule.Common(2002, 1, 5, 8));
		RegisterToItem(4345, new CommonDrop(3191, 10, 1, 3, 3));
		RegisterToItem(4345, ItemDropRule.Common(2895, 20));
	}

	private void RegisterOyster()
	{
		IItemDropRule[] rules = new IItemDropRule[3]
		{
			ItemDropRule.NotScalingWithLuck(4414, 15),
			ItemDropRule.NotScalingWithLuck(4413, 3),
			ItemDropRule.NotScalingWithLuck(4412)
		};
		RegisterToItem(4410, ItemDropRule.SequentialRulesNotScalingWithLuck(5, rules));
		RegisterToItem(4410, ItemDropRule.Common(4411));
	}

	private void RegisterCapricorns()
	{
		RegisterToItem(5059, ItemDropRule.Common(5060));
		RegisterToItem(5060, ItemDropRule.Common(5059));
	}
}

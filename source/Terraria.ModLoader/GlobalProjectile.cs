...
public abstract class GlobalProjectile : GlobalType<Projectile, GlobalProjectile>
{
	...
	{
		base.ValidateType();
		LoaderUtils.MustOverrideTogether(this, (GlobalProjectile g) => new Action<Projectile, BitWriter, BinaryWriter>(g.SendExtraAI), (GlobalProjectile g) => new Action<Projectile, BitReader, BinaryReader>(g.ReceiveExtraAI));
	}

...
public abstract class ModPlayer : ModType<Player, ModPlayer>, IIndexed
{
	...
	/// </summary>
	public Player Player => base.Entity;
	...
	{
		base.ValidateType();
		LoaderUtils.MustOverrideTogether(this, (ModPlayer p) => new Action<TagCompound>(SaveData), (ModPlayer p) => new Action<TagCompound>(LoadData));
		LoaderUtils.MustOverrideTogether(this, (ModPlayer p) => new Action<ModPlayer>(p.CopyClientState), (ModPlayer p) => new Action<ModPlayer>(p.SendClientChanges));
	}
	...
	/// <summary>
	/// This hook runs before the <see cref="P:Terraria.DataStructures.ExtraJumpState.Active" /> flag for an extra jump is set from <see langword="true" /> to <see langword="false" /> when the extra jump's duration has expired<br />
	...
	/// <summary>
	/// This hook runs before the <see cref="P:Terraria.DataStructures.ExtraJumpState.Available" /> flag for an extra jump is set to <see langword="true" /> in <see cref="M:Terraria.Player.RefreshDoubleJumps" /><br />
	...
	/// <summary>
	/// Return <see langword="false" /> to prevent <see cref="M:Terraria.ModLoader.ExtraJump.ShowVisuals(Terraria.Player)" /> from executing on <paramref name="jump" />.<br />

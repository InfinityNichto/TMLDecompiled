...
public abstract class ModMenu : ModType
{
	...
	/// </summary>
	public virtual Asset<Texture2D> Logo => modLoaderLogo ?? (modLoaderLogo = ModLoader.ManifestAssets.Request<Texture2D>("Terraria.ModLoader.Logo"));
	...
	/// </summary>
	public virtual string DisplayName => base.Mod.DisplayName;

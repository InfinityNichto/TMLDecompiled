...
public abstract class ModNPC : ModType<NPC, ModNPC>, ILocalizedModType, IModType
{
	...
	protected sealed override void Register()
	{
		...
		Type type = GetType();
		if (type.GetAttribute<AutoloadHead>() != null)
		{
			base.Mod.AddNPCHeadTexture(NPC.type, HeadTexture);
		}
		if (type.GetAttribute<AutoloadBossHead>() != null)
		{
			base.Mod.AddBossHeadTexture(BossHeadTexture, NPC.type);
		}
	}
	...
	public sealed override void SetupContent()
	{
		...
		AutoStaticDefaults();
		SetStaticDefaults();
		NPCID.Search.Add(base.FullName, Type);
	}
	...
	public virtual void AutoStaticDefaults()
	{
		...
		{
			Logging.tML.Warn((object)Language.GetTextValue("tModLoader.LoadWarningBannerOrBannerItemNotSet", base.Mod.DisplayName, Name));
		}

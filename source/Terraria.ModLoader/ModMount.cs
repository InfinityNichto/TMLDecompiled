...
public abstract class ModMount : ModType<Mount.MountData, ModMount>
{
	...
	/// </summary>
	public Mount.MountData MountData => base.Entity;
	...
	protected sealed override void Register()
	{
		...
		foreach (MountTextureType textureType in Enum.GetValues(typeof(MountTextureType)))
		{
			...
			if (!string.IsNullOrEmpty(extraTexture) && ModContent.RequestIfExists(extraTexture, out Asset<Texture2D> textureAsset, AssetRequestMode.AsyncLoad))
			{
				switch (textureType)
				{

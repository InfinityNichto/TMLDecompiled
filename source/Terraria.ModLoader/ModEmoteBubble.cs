...
public abstract class ModEmoteBubble : ModType<EmoteBubble, ModEmoteBubble>, ILocalizedModType, IModType
{
	...
	/// </summary>
	public EmoteBubble EmoteBubble => base.Entity;
	...
	/// </summary>
	public virtual LocalizedText Command => this.GetLocalization("Command", () => Name.ToLower());
	...
	{
		return new EmoteBubble(Type, new WorldUIAnchor())
		{
			ModEmoteBubble = this
		};
	}
	...
	public void AddToCategory(int categoryId)
	{
		...
		{
			EmoteBubbleLoader.categoryEmoteLookup.Add(categoryId, new List<ModEmoteBubble> { this });
		}
		else
		{
			list.Add(this);

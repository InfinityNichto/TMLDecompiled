...
public abstract class ModItem : ModType<Item, ModItem>, ILocalizedModType, IModType
{
	...
	protected sealed override void Register()
	{
		...
		Item.ModItem = this;
		AutoloadEquip autoloadEquip = GetType().GetAttribute<AutoloadEquip>();
		if (autoloadEquip != null)
		{
			EquipType[] equipTypes = autoloadEquip.equipTypes;
			foreach (EquipType equip in equipTypes)
			{
				EquipLoader.AddEquipTexture(base.Mod, $"{Texture}_{equip}", equip, this);
			}
		}
	...
	public sealed override void SetupContent()
	{
		...
		AutoStaticDefaults();
		SetStaticDefaults();
		ItemID.Search.Add(base.FullName, Type);
	}
	...
	public virtual void AutoStaticDefaults()
	{
		...
		if (ModContent.RequestIfExists(Texture + "_Flame", out Asset<Texture2D> flameTexture, AssetRequestMode.AsyncLoad))
		{

...
public class TileObjectData
{
	...
	private void Calculate()
	{
		...
		if (Height == _tileObjectCoords.heights.Length || Height < _tileObjectCoords.heights.Length)
		{
			return;
		}
		FixNewTile();
	...
	public static TileObjectData GetTileData(Tile getTile)
	{
		...
		int num6 = ((!tileObjectData.StyleHorizontal) ? (num * num3 + num2) : (num2 * num3 + num));
		...
		if (styleLineSkip > 1)
		{
			...
			{
				num4 = num2 / styleLineSkip * num3 + num;
				num5 = num2 % styleLineSkip;
			}
			else
			{
				num4 = num / styleLineSkip * num3 + num2;
				num5 = num % styleLineSkip;
			}
		}
	...
	public static int GetTileStyle(Tile getTile)
	{
		...
		int num4 = ((!tileObjectData.StyleHorizontal) ? (num * num3 + num2) : (num2 * num3 + num)) / tileObjectData.StyleMultiplier;
		int styleLineSkip = tileObjectData.StyleLineSkip;
		if (styleLineSkip > 1)
		{
			num4 = ((!tileObjectData.StyleHorizontal) ? (num / styleLineSkip * num3 + num2) : (num2 / styleLineSkip * num3 + num));
		}
		return num4;
	}

...
public static class DyeInitializer
{
	...
	private static void LoadLegacyHairdyes()
	{
		...
		GameShaders.Hair.BindShader(1977, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			((Color)(ref newColor)).R = (byte)((float)player.statLife / (float)player.statLifeMax2 * 235f + 20f);
			((Color)(ref newColor)).B = 20;
			((Color)(ref newColor)).G = 20;
			return newColor;
		}));
		GameShaders.Hair.BindShader(1978, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			((Color)(ref newColor)).R = (byte)((1f - (float)player.statMana / (float)player.statManaMax2) * 200f + 50f);
			((Color)(ref newColor)).B = byte.MaxValue;
			((Color)(ref newColor)).G = (byte)((1f - (float)player.statMana / (float)player.statManaMax2) * 180f + 75f);
			return newColor;
		}));
		GameShaders.Hair.BindShader(1979, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			if (center.Y < num27)
			{
				...
				((Color)(ref newColor)).R = (byte)(116f * num32 + 28f * num31);
				((Color)(ref newColor)).G = (byte)(160f * num32 + 216f * num31);
				((Color)(ref newColor)).B = (byte)(249f * num32 + 94f * num31);
			}
			else if (center.Y < num28)
			{
				...
				((Color)(ref newColor)).R = (byte)(28f * num35 + 151f * num34);
				((Color)(ref newColor)).G = (byte)(216f * num35 + 107f * num34);
				((Color)(ref newColor)).B = (byte)(94f * num35 + 75f * num34);
			}
			else if (center.Y < num29)
			{
				...
				((Color)(ref newColor)).R = (byte)(151f * num38 + 128f * num37);
				((Color)(ref newColor)).G = (byte)(107f * num38 + 128f * num37);
				((Color)(ref newColor)).B = (byte)(75f * num38 + 128f * num37);
			}
			else if (center.Y < num30)
			{
				...
				((Color)(ref newColor)).R = (byte)(128f * num41 + 255f * num40);
				((Color)(ref newColor)).G = (byte)(128f * num41 + 50f * num40);
				((Color)(ref newColor)).B = (byte)(128f * num41 + 15f * num40);
			}
			else
			{
				((Color)(ref newColor)).R = byte.MaxValue;
				((Color)(ref newColor)).G = 50;
				((Color)(ref newColor)).B = 10;
			}
			return newColor;
		}));
		GameShaders.Hair.BindShader(1980, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			((Color)(ref val7))._002Ector(226, 118, 76);
			Color val8 = default(Color);
			((Color)(ref val8))._002Ector(174, 194, 196);
			Color val9 = default(Color);
			((Color)(ref val9))._002Ector(204, 181, 72);
			Color val10 = default(Color);
			((Color)(ref val10))._002Ector(161, 172, 173);
			if ((float)num15 < num16)
			{
				float num19 = (float)num15 / num16;
				float num20 = 1f - num19;
				((Color)(ref newColor)).R = (byte)((float)(int)((Color)(ref val7)).R * num20 + (float)(int)((Color)(ref val8)).R * num19);
				((Color)(ref newColor)).G = (byte)((float)(int)((Color)(ref val7)).G * num20 + (float)(int)((Color)(ref val8)).G * num19);
				((Color)(ref newColor)).B = (byte)((float)(int)((Color)(ref val7)).B * num20 + (float)(int)((Color)(ref val8)).B * num19);
			}
			else if ((float)num15 < num17)
			{
				...
				((Color)(ref newColor)).R = (byte)((float)(int)((Color)(ref val8)).R * num23 + (float)(int)((Color)(ref val9)).R * num22);
				((Color)(ref newColor)).G = (byte)((float)(int)((Color)(ref val8)).G * num23 + (float)(int)((Color)(ref val9)).G * num22);
				((Color)(ref newColor)).B = (byte)((float)(int)((Color)(ref val8)).B * num23 + (float)(int)((Color)(ref val9)).B * num22);
			}
			else if ((float)num15 < num18)
			{
				...
				((Color)(ref newColor)).R = (byte)((float)(int)((Color)(ref val9)).R * num26 + (float)(int)((Color)(ref val10)).R * num25);
				((Color)(ref newColor)).G = (byte)((float)(int)((Color)(ref val9)).G * num26 + (float)(int)((Color)(ref val10)).G * num25);
				((Color)(ref newColor)).B = (byte)((float)(int)((Color)(ref val9)).B * num26 + (float)(int)((Color)(ref val10)).B * num25);
			}
			else
			{
				newColor = val10;
		...
		GameShaders.Hair.BindShader(1981, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			((Color)(ref val3))._002Ector(1, 142, 255);
			Color val4 = default(Color);
			((Color)(ref val4))._002Ector(255, 255, 0);
			Color val5 = default(Color);
			((Color)(ref val5))._002Ector(211, 45, 127);
			Color val6 = default(Color);
			((Color)(ref val6))._002Ector(67, 44, 118);
			if (Main.dayTime)
			{
				if (Main.time < 27000.0)
				{
					...
					float num6 = 1f - num5;
					((Color)(ref newColor)).R = (byte)((float)(int)((Color)(ref val3)).R * num6 + (float)(int)((Color)(ref val4)).R * num5);
					((Color)(ref newColor)).G = (byte)((float)(int)((Color)(ref val3)).G * num6 + (float)(int)((Color)(ref val4)).G * num5);
					((Color)(ref newColor)).B = (byte)((float)(int)((Color)(ref val3)).B * num6 + (float)(int)((Color)(ref val4)).B * num5);
				}
				else
				{
					float num7 = 27000f;
					...
					float num9 = 1f - num8;
					((Color)(ref newColor)).R = (byte)((float)(int)((Color)(ref val4)).R * num9 + (float)(int)((Color)(ref val5)).R * num8);
					((Color)(ref newColor)).G = (byte)((float)(int)((Color)(ref val4)).G * num9 + (float)(int)((Color)(ref val5)).G * num8);
					((Color)(ref newColor)).B = (byte)((float)(int)((Color)(ref val4)).B * num9 + (float)(int)((Color)(ref val5)).B * num8);
				}
			}
			else if (Main.time < 16200.0)
			{
				...
				((Color)(ref newColor)).R = (byte)((float)(int)((Color)(ref val5)).R * num11 + (float)(int)((Color)(ref val6)).R * num10);
				((Color)(ref newColor)).G = (byte)((float)(int)((Color)(ref val5)).G * num11 + (float)(int)((Color)(ref val6)).G * num10);
				((Color)(ref newColor)).B = (byte)((float)(int)((Color)(ref val5)).B * num11 + (float)(int)((Color)(ref val6)).B * num10);
			}
			else
			{
				float num12 = 16200f;
				...
				((Color)(ref newColor)).R = (byte)((float)(int)((Color)(ref val6)).R * num14 + (float)(int)((Color)(ref val3)).R * num13);
				((Color)(ref newColor)).G = (byte)((float)(int)((Color)(ref val6)).G * num14 + (float)(int)((Color)(ref val3)).G * num13);
				((Color)(ref newColor)).B = (byte)((float)(int)((Color)(ref val6)).B * num14 + (float)(int)((Color)(ref val3)).B * num13);
			}
			return newColor;
		}));
		...
		GameShaders.Hair.BindShader(1983, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			{
				val = ((Main.waterStyle == 2) ? new Color(124, 118, 242) : ((Main.waterStyle == 3) ? new Color(143, 215, 29) : ((Main.waterStyle == 4) ? new Color(78, 193, 227) : ((Main.waterStyle == 5) ? new Color(189, 231, 255) : ((Main.waterStyle == 6) ? new Color(230, 219, 100) : ((Main.waterStyle == 7) ? new Color(151, 107, 75) : ((Main.waterStyle == 8) ? new Color(128, 128, 128) : ((Main.waterStyle == 9) ? new Color(200, 0, 0) : ((Main.waterStyle == 10) ? new Color(208, 80, 80) : ((Main.waterStyle == 12) ? new Color(230, 219, 100) : ((Main.waterStyle != 13) ? new Color(28, 216, 94) : new Color(28, 216, 94))))))))))));
				if (Main.waterStyle >= 15)
				{
					val = LoaderManager.Get<WaterStylesLoader>().Get(Main.waterStyle).BiomeHairColor();
				}
			}
			else
			{
				TorchID.TorchColor(23, out var R, out var G, out var B);
				((Color)(ref val))._002Ector(R, G, B);
			}
			Color val2 = player.hairDyeColor;
			if (((Color)(ref val2)).A == 0)
			{
				val2 = val;
			}
			if (((Color)(ref val2)).R > ((Color)(ref val)).R)
			{
				byte r = ((Color)(ref val2)).R;
				((Color)(ref val2)).R = (byte)(r - 1);
			}
			if (((Color)(ref val2)).R < ((Color)(ref val)).R)
			{
				byte r = ((Color)(ref val2)).R;
			...
			if (((Color)(ref val2)).G > ((Color)(ref val)).G)
			{
				byte r = ((Color)(ref val2)).G;
				((Color)(ref val2)).G = (byte)(r - 1);
			}
			if (((Color)(ref val2)).G < ((Color)(ref val)).G)
			{
				byte r = ((Color)(ref val2)).G;
			...
			if (((Color)(ref val2)).B > ((Color)(ref val)).B)
			{
				byte r = ((Color)(ref val2)).B;
				((Color)(ref val2)).B = (byte)(r - 1);
			}
			if (((Color)(ref val2)).B < ((Color)(ref val)).B)
			{
				byte r = ((Color)(ref val2)).B;
		...
		GameShaders.Hair.BindShader(1984, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			((Color)(ref newColor))._002Ector(244, 22, 175);
			return newColor;
		}));
		GameShaders.Hair.BindShader(1985, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			((Color)(ref newColor))._002Ector(Main.DiscoR, Main.DiscoG, Main.DiscoB);
			return newColor;
		}));
		GameShaders.Hair.BindShader(1986, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			float num3 = num / num2;
			float num4 = 1f - num3;
			((Color)(ref newColor)).R = (byte)(75f * num3 + (float)(int)((Color)(ref player.hairColor)).R * num4);
			((Color)(ref newColor)).G = (byte)(255f * num3 + (float)(int)((Color)(ref player.hairColor)).G * num4);
			((Color)(ref newColor)).B = (byte)(200f * num3 + (float)(int)((Color)(ref player.hairColor)).B * num4);
			return newColor;
		}));
		GameShaders.Hair.BindShader(2863, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			((Color)(ref newColor)).R = (byte)(((Color)(ref color)).R + ((Color)(ref newColor)).R >> 1);
			((Color)(ref newColor)).G = (byte)(((Color)(ref color)).G + ((Color)(ref newColor)).G >> 1);
			((Color)(ref newColor)).B = (byte)(((Color)(ref color)).B + ((Color)(ref newColor)).B >> 1);
			return newColor;
		}));
	}

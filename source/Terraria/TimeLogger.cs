...
public static class TimeLogger
{
	...
	public static void NewDrawFrame()
	{
		...
		if (currentlyLogging)
		{
			...
			handler.AppendLiteral("Start of Frame #");
			handler.AppendFormatted(currentFrame);
	...
	public static void EndDrawFrame()
	{
		if (currentFrame <= framesToLog)
		{
			...
			handler.AppendLiteral("End of Frame #");
			handler.AppendFormatted(currentFrame);
			stringBuilder.AppendLine(ref handler);
	...
	public static void MenuDrawTime(double timeElapsed)
	{
		if (currentlyLogging)
		{
			...
			handler.AppendLiteral("Menu Render Time : ");
			handler.AppendFormatted(timeElapsed, "F4");
			stringBuilder.AppendLine(ref handler);
		}
	}
	...
	public static void SplashDrawTime(double timeElapsed)
	{
		if (currentlyLogging)
		{
			...
			handler.AppendLiteral("Splash Render Time : ");
			handler.AppendFormatted(timeElapsed, "F4");
			stringBuilder.AppendLine(ref handler);
		}
	}
	...
	public static void MapDrawTime(double timeElapsed)
	{
		if (currentlyLogging)
		{
			...
			handler.AppendLiteral("Full Screen Map Render Time : ");
			handler.AppendFormatted(timeElapsed, "F4");
			stringBuilder.AppendLine(ref handler);
		}
	}

...
public class ItemID
{
	...
	public class Sets
	{
		...
		/// </remarks>
		public static Color[][] FoodParticleColors = Factory.CreateCustomSet((Color[])(object)new Color[0], (short)357, new Color[2]
		{
		...
		/// <see cref="F:Terraria.ID.ItemID.Sets.IsFood" /> does not need to be set for dust to be created.
		/// </remarks>
		public static Color[][] DrinkParticleColors = Factory.CreateCustomSet((Color[])(object)new Color[0], (short)28, new Color[3]
		{
			new Color(164, 16, 47),
			new Color(246, 34, 79),
		...
		/// </summary>
		public static int[] ExtractinatorMode = Factory.CreateIntSet(-1, 424, 0, 1103, 0, 3347, 3347, 2339, 2337, 2338, 2337, 2337, 2337, 4354, 4354, 4389, 4354, 4377, 4354, 4378, 4354, 5127, 4354, 5128, 4354);
		...
		/// </remarks>
		public static float[] StaffMinionSlotsRequired = Factory.CreateFloatSet(1f);
		...
		/// </summary>
		public static bool[] PreHardmodeLikeBossBag = Factory.CreateBoolSet(3318, 3319, 3320, 3321, 3322, 3323, 3324, 4957, 5111);
		...
		/// </summary>
		public static bool[] CatchingTool = Factory.CreateBoolSet(1991, 3183, 4821);
		...
		/// </summary>
		public static bool[] LavaproofCatchingTool = Factory.CreateBoolSet(3183, 4821);
		...
		/// </summary>
		public static bool[] Spears = Factory.CreateBoolSet(280, 277, 2332, 4061, 802, 274, 537, 1186, 390, 1193, 406, 1200, 2331, 550, 756, 3836, 1228, 1947);
		...
		public static int[] CoinLuckValue = Factory.CreateIntSet(0, 71, 1, 72, 100, 73, 10000, 74, 1000000);
		...
		/// </summary>
		public static bool[] IsRangedSpecialistWeapon = Factory.CreateBoolSet(1156, 3350, 3210, 160, 3821);
		...
		/// </summary>
		public static Dictionary<int, (int minStack, int maxStack)> GeodeDrops = new Dictionary<int, (int, int)>
		{
			{
				177,
				(3, 7)
		...
		/// <br />Stack sizes with less than 1 or where minStack is not strictly smaller than maxStack will lead to exceptions being thrown.
		/// </summary>
		public static Dictionary<int, (int minStack, int maxStack)> OreDropsFromSlime = new Dictionary<int, (int, int)>
		{
			{
				12,
				(3, 13)
		...
		/// </summary>
		public static bool[] IsSpaceGun = Factory.CreateBoolSet(false, 127, 4347, 4348);
	}

...
public static class GoreID
{
	public static class Sets
	{
		...
		/// <summary>
		/// If <see langword="true" /> for a given gore type (<see cref="F:Terraria.Gore.type" />), then that gore has columns in its sprite corresponding to the amount of tile paints, and Gore.Frame.CurrentColumn will be set to tile.TileColor on spawn if it's coming from a tree via wind effects.
		/// <br /> Defaults to <see langword="false" />.
		/// </summary>

...
public class TileID
{
	public static class Sets
	{
		...
		public static bool[] Grass = Factory.CreateBoolSet(2, 23, 109, 199, 477, 492, 633);
		...
		public static bool[] IsMultitile = Factory.CreateBoolSet(28, 31, 233, 236, 238, 530);
		...
		public static bool[] IsValidSpawnPoint = Factory.CreateBoolSet(79);
		...
		public static bool[] Torch = Factory.CreateBoolSet(4);
		...
		public static bool[] Campfire = Factory.CreateBoolSet(215);

		/// <summary> Whether or not this tile is a clock. </summary>
		public static bool[] Clock = Factory.CreateBoolSet(104);
		...
		public static bool[] TreeSapling = Factory.CreateBoolSet(20);
		...
		/// </summary>
		public static int[] CountsAsPylon = new int[1] { 597 };
		...
		/// </summary>
		public static bool[] WallsMergeWith = Factory.CreateBoolSet(54);
		...
		/// </summary>
		public static bool?[] BlockMergesWithMergeAllBlockOverride = Factory.CreateCustomSet<bool?>(null, new object[6] { 10, false, 387, false, 541, false });

		/// <summary>
		/// Allows tiles to be placed next to any tile or wall. (Tiles normally need a <see cref="F:Terraria.Main.tileSolid" /> tile, <see cref="F:Terraria.ID.TileID.Rope" /> tile, <see cref="F:Terraria.ID.TileID.Sets.IsBeam" /> tile, or a wall adjacent to the target position to be placeable.)
		/// <br>Used by: Cobweb, Coin Piles, Living Fire Blocks, Smoke Blocks, Bubble Blocks</br>
		/// </summary>
		public static bool[] CanPlaceNextToNonSolidTile = Factory.CreateBoolSet(false, 51, 330, 331, 332, 333, 336, 340, 341, 342, 343, 344, 351, 379);

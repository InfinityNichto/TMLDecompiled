...
public class ProjectileID
{
	public static class Sets
	{
		...
		/// <summary>
		/// If <see langword="true" /> for a given projectile type (<see cref="F:Terraria.Projectile.type" />), then that projectile will do the same damage to players regardless of difficulty (expert/master etc). <br />
		...
		/// </summary>
		public static float[] SummonTagDamageMultiplier = Factory.CreateFloatSet(1f, 864f, 0.75f, 688f, 0.5f, 689f, 0.5f, 690f, 0.5f);

...
public class AllPersonalitiesModifier : IShopPersonalityTrait
{
	...
	internal static void RegisterVanillaNpcRelationships(NPC npc)
	{
		...
		HelperInfo info = default(HelperInfo);
		info.npc = npc;
		RegisterNpcToNpcRelationships(info, npcHappiness);
	}
	...
	{
		NearbyNpcsDummy nearbyNPCsByType = default(NearbyNpcsDummy);
		ShopHelperDummy shopHelperInstance = new ShopHelperDummy(npcHappiness);

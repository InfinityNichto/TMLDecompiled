...
public class UIVirtualKeyboard : UIState
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		Rectangle val = _textBox.GetDimensions().ToRectangle();
		...
		byte b = (byte)((255 + ((Color)(ref Main.tileColor)).R * 2) / 3);
		Color value = default(Color);
		((Color)(ref value))._002Ector((int)b, (int)b, (int)b, 255);
		...
		val = _textBox.GetDimensions().ToRectangle();

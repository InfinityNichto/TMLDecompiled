...
public class UIBestiaryTest : UIState
{
	...
	private void FillProgressBottomBar(UIElement container)
	{
		...
		container.Append(_unlocksProgressBar = new UIBestiaryBar(Main.BestiaryDB)
		{
			Width = new StyleDimension(0f, 1f),
	...
	private void AddSearchBar(UIElement innerTopContainer, UIBestiaryEntryInfoPage infoSpace)
	{
		...
		uIPanel.SetPadding(0f);
		innerTopContainer.Append(uIPanel);
		UISearchBar obj2 = new UISearchBar(Language.GetText("UI.PlayerNameSlot"), 0.8f)
		{
			Width = new StyleDimension(0f, 1f),
			Height = new StyleDimension(0f, 1f),
			HAlign = 0f,
	...
	private void SetupGamepadPoints(SpriteBatch spriteBatch)
	{
		...
		UILinkPoint uILinkPoint7 = MakeLinkPointFromSnapPoint(currentID++, snap2);
		UILinkPoint uILinkPoint8 = MakeLinkPointFromSnapPoint(currentID++, snap6);
		UILinkPoint uILinkPoint9 = MakeLinkPointFromSnapPoint(currentID++, snap4);
		UILinkPoint uILinkPoint10 = MakeLinkPointFromSnapPoint(currentID++, snap3);
		UILinkPoint rightSide = MakeLinkPointFromSnapPoint(currentID++, snap5);
		PairLeftRight(uILinkPoint, uILinkPoint7);
		PairLeftRight(uILinkPoint7, uILinkPoint10);
		PairLeftRight(uILinkPoint10, uILinkPoint9);
		PairLeftRight(uILinkPoint9, rightSide);
		uILinkPoint8.Up = uILinkPoint7.ID;
		...
		if (_filteringGrid.Parent != null)
		{
			...
			PairUpDown(uILinkPoint7, uILinkPoint8);
			PairUpDown(uILinkPoint, uILinkPoint8);
			for (int num2 = gridWidth - 1; num2 >= 0; num2--)
			{
				UILinkPoint uILinkPoint11 = gridPoints[num2, gridHeight - 1];
				if (uILinkPoint11 != null)
				{
					PairUpDown(uILinkPoint11, uILinkPoint8);
				}
				UILinkPoint uILinkPoint12 = gridPoints[num2, gridHeight - 2];
				if (uILinkPoint12 != null && uILinkPoint11 == null)
				{
					PairUpDown(uILinkPoint12, uILinkPoint8);
				}
				UILinkPoint uILinkPoint13 = gridPoints[num2, 0];
				if (uILinkPoint13 != null)
				{
					if (num2 < gridWidth - 3)
					{
						PairUpDown(uILinkPoint10, uILinkPoint13);
					}
					else
					{
						PairUpDown(uILinkPoint9, uILinkPoint13);
					}
				}
			}
		}
		else if (_sortingGrid.Parent != null)
		{
			...
			{
				UILinkPoint uILinkPoint14 = gridPoints[num3, gridHeight - 1];
				if (uILinkPoint14 != null)
				{
					PairUpDown(uILinkPoint14, uILinkPoint8);
				}
				UILinkPoint uILinkPoint2 = gridPoints[num3, 0];
				if (uILinkPoint2 != null)
				{
					PairUpDown(uILinkPoint9, uILinkPoint2);
					PairUpDown(uILinkPoint10, uILinkPoint2);
				}
			}
		}
		else if (_entryGrid.Parent != null)
		{
			...
			for (int j = 0; j < gridWidth; j++)
			{
				if (gridHeight - 1 >= 0)
				{
					UILinkPoint uILinkPoint3 = gridPoints[j, gridHeight - 1];
					if (uILinkPoint3 != null)
					{
						PairUpDown(uILinkPoint3, uILinkPoint8);
					}
					if (gridHeight - 2 >= 0)
					{
						UILinkPoint uILinkPoint4 = gridPoints[j, gridHeight - 2];
						if (uILinkPoint4 != null && uILinkPoint3 == null)
						{
							PairUpDown(uILinkPoint4, uILinkPoint8);
						}
					}
				}
				UILinkPoint uILinkPoint5 = gridPoints[j, 0];
				if (uILinkPoint5 != null)
				{
					if (j < gridWidth / 2)
					{
						PairUpDown(uILinkPoint7, uILinkPoint5);
					}
					else if (j == gridWidth - 1)
					{
						PairUpDown(uILinkPoint9, uILinkPoint5);
					}
					else
					{
						PairUpDown(uILinkPoint10, uILinkPoint5);
					}
				}
			}
			UILinkPoint uILinkPoint6 = gridPoints[0, 0];
			if (uILinkPoint6 != null)
			{
				PairUpDown(uILinkPoint7, uILinkPoint6);
				PairUpDown(uILinkPoint, uILinkPoint6);
			}
			else
			{
				PairUpDown(uILinkPoint7, uILinkPoint8);
				PairUpDown(uILinkPoint, uILinkPoint8);
				PairUpDown(uILinkPoint9, uILinkPoint8);
				PairUpDown(uILinkPoint10, uILinkPoint8);
			}
		}

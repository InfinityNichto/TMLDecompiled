...
public class UIToggleImage : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		spriteBatch.Draw(value, new Rectangle((int)dimensions.X, (int)dimensions.Y, _drawWidth, _drawHeight), (Rectangle?)new Rectangle(point.X, point.Y, _drawWidth, _drawHeight), color);
	}
